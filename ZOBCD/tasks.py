...
class SST2Dataset(Dataset):
    ...
    def load_dataset(self, path, **kwargs):
        ...
        path_train = 'datasets/glue_sst2/train/'
        path_valid = 'datasets/glue_sst2/validation/'
        train_d = load_from_disk(path_train)
        validation_d = load_from_disk(path_valid)
...
class CopaDataset(Dataset):
    ...
    def load_dataset(self, path, **kwargs):
        ...
        path_train = 'datasets/super_glue_copa/train/'
        path_valid = 'datasets/super_glue_copa/validation/'
        train_examples = load_from_disk(path_train)
        valid_examples = load_from_disk(path_valid)
...
class MultiRCDataset(Dataset):
    ...
    def load_dataset(self, path, **kwargs):
        ...
        path_train = 'datasets/super_glue_multirc/train/'
        path_valid = 'datasets/super_glue_multirc/validation/'
        train_set = load_from_disk(path_train)
        valid_set = load_from_disk(path_valid)
...
class CBDataset(Dataset):
    ...
    def load_dataset(self, path, **kwargs):
        ...
        path_train = 'datasets/super_glue_cb/train/'
        path_valid = 'datasets/super_glue_cb/validation/'
        train_set = load_from_disk(path_train)
        valid_set = load_from_disk(path_valid)
...
class WICDataset(Dataset):
    ...
    def load_dataset(self, path, **kwargs):
        ...
        path_train = 'datasets/super_glue_wic/train/'
        path_valid = 'datasets/super_glue_wic/validation/'
        train_set = load_from_disk(path_train)
        valid_set = load_from_disk(path_valid)
...
class WSCDataset(Dataset):
    ...
    def load_dataset(self, path, **kwargs):
        ...
        path_train = 'datasets/super_glue_wsc/train/'
        path_valid = 'datasets/super_glue_wsc/validation/'
        train_set = load_from_disk(path_train)
        valid_set = load_from_disk(path_valid)
...
class RTEDataset(Dataset):
    ...
    def load_dataset(self, path, **kwargs):
        ...
        path_train = 'datasets/super_glue_rte/train/'
        path_valid = 'datasets/super_glue_rte/validation/'
        train_set = load_from_disk(path_train)
        valid_set = load_from_disk(path_valid)
...
class WinoGrandeDataset(Dataset):
    ...
    def load_dataset(self, path, **kwargs):
        path_train = 'datasets/winogrande/train/'
        path_valid = 'datasets/winogrande/validation/'
        train_set = load_from_disk(path_train)
        valid_set = load_from_disk(path_valid)
